...
<div class="flex justify-center">
    <div class="flex w-8/12 bg-gray-100 rounded shadow-md mt-10 p-6">
        <div class="flex flex-col justify-center w-full">
            <h1 class="sm:text-4xl capitalize my-6 text-2xl text-center text-purple-600 tracking-wide">
                Woooooop Woooooop there is no such page wooooooooop
            </h1>
            <div class="flex mb-4 justify-center w-full">
                <svg class="fill-current w-3/6"
                    id="a706cf1c-1654-439b-8fcf-310eb7aa0e00" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                        ...
                        transform="translate(-39.70387 -61.04208)" fill="#8e5bb3"/>
                    <path
...
<?php /**PATH C:\Users\Jawana\Desktop\teethStudents\resources\views/404.blade.php ENDPATH**/ ?>